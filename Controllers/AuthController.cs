...
namespace WebGenerateImage.Controllers
{
    public class AuthController : Controller
    {
        ...
        public async Task<IActionResult> VerifyOtpAndRegister(string email, string otpCode, string password, string confirmPassword, bool enableFaceAuth = false)
        {
            ...
            CreateUserDirectory(email); // ✅ Tạo thư mục người dùng sau khi đăng ký
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null, string remoteError = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                if (email != null)
                {
                    CreateUserDirectory(email); // ✅ Tạo thư mục khi Google đăng nhập thành công
                }
            ...
            else
            {
                ...
                if (email != null)
                {
                    ...
                    CreateUserDirectory(email); // ✅ Tạo thư mục khi tài khoản Google vừa được tạo
        ...
        private void CreateUserDirectory(string email)
        {
            ...
            var userFolder = Path.Combine(_env.WebRootPath, "UserFolders", sanitizedEmail);
